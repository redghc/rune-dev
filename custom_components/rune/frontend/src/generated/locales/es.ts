...
's7caffba29d6248f7': str`Cada comando también se expone a Home Assistant como una entidad de botón: visible en Ajustes → Dispositivos y servicios → ${0} y en el panel de Botones. Pasa el ratón sobre cualquier tarjeta para editar, re-aprender o eliminar.`,
