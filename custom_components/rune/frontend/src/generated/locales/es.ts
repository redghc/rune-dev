...
's079ffc0734880df6': str`La etiqueta es obligatoria.`,
's08270ee8b94a3612': str`Cargar sniffer`,
's0b0a02a4470de153': str`Dispositivo`,
...
's166b334e7c0792db': str`Arreglo JSON. Marcas positivas, espacios negativos. Edita un valor para ajustar un microsegundo mal capturado.`,
...
's1b897015174c6e80': str`Revisar y guardar`,
's1cacf2d37fdc602a': str`Los tiempos en bruto deben ser un arreglo JSON de enteros: ${0}`,
's1d3e7ffaf97696e0': str`No se encontraron receptores IR/RF`,
's1ee96debc21e1e35': str`Inactivo: pulsa en Iniciar aprendizaje`,
's1fd450a6b64d643b': str`Persiana`,
...
's39815487d61bb4cc': str`Los tiempos en bruto deben ser un arreglo JSON de enteros.`,
...
's5635de8dcac23eef': str`Eliminar comando`,
's593d9c27e95706a7': str`Entidad emisora IR que envía comandos`,
's5b36817ae410d161': str`Cada comando también se expone a Home Assistant como una entidad de botón: visible en Ajustes → Dispositivos y servicios → ${0} y en el panel de Botones. Usa los botones Editar / Re-aprender / Eliminar bajo cada tarjeta para gestionarlos.`,
's5b55db76417c9d56': str`Capturando… pulsa el botón del mando ahora mismo`,
...
's5e97e8e97cfa458b': str`Ocultar este mando de la lista del sniffer`,
's617112910d952e74': str`Eliminado «${0}»`,
's61e136c0658e27d5': str`Protocolo`,
...
's8cbebb24ca173a81': str`Comando actualizado`,
...
'saf83fe143a83b854': str`Eliminar «${0}»`,
'sb0a3ab9fec778bb7': str`Capturado: ${0} @ ${1} Hz`,
'sb229529406212829': str`Define la categoría, el nombre y la entidad emisora que transmitirá los comandos del dispositivo.`,
...
'sb63c2836e9bab938': str`Tiempos en bruto (µs, signos alternados)`,
'sb76488ba10c89f3a': str`Guardar y cerrar`,
'sb78c736a0c349d12': str`Confirmar eliminación`,
'sb87de2c2a3cb592d': str`Re-aprender «${0}»`,
...
'sc366819bd9a5f389': str`Rol semántico (power, speed_preset, volume, …). Lo usan las plataformas de entidades para exponer los controles adecuados.`,
...
'sd874f6567e9c0fed': str`Clave del comando`,
'sdaf3cc7acb678d84': str`Las vinculaciones de acciones asocian una señal capturada con una consecuencia: disparar un pulso en un dispositivo, llamar a un servicio, activar una escena, ejecutar un script o disparar un evento. Se gestionan mediante la API (la API es estable; un editor visual llegará en v0.4).`,
...
'sdd907db93bf499ca': str`Tiempos en bruto`,
'sdee9150a992fb250': str`Reactivar este mando`,
'se2546f76ed66ba22': str`¿Eliminar el comando «${0}» de ${1}?`,
...
'see7dbc2d10dc7273': str`Esta acción es permanente y no se puede deshacer.`,
